export const translations = {
  ...
  uk: {
    ...
    timeline: {
      title: "Обговорення книг",
      sub: "Діліться думками, запитуйте, обговорюйте книги",
      composePlaceholder: "Поділіться думкою, рецензією або запитанням про книгу...",
      linkBook: "Прив'язати книгу",
      post: "Опублікувати",
      posting: "Публікація...",
      likes: "вподобань",
      like: "Вподобати",
      ...
      send: "Надіслати",
      noPostsTitle: "Ще немає публікацій",
      noPostsSub: "Будьте першим, хто почне обговорення!",
      deletePost: "Видалити",
      ...
      searchBook: "Пошук книги...",
      newBook: "додав(ла) нову книгу",
      filterAll: "Всі",
      filterDiscussions: "Обговорення",
      filterNewBooks: "Нові книги",
    },
    people: {
      title: "Люди",
      sub: "Ваші контакти та спільнота КнигоОбміну",
      searchPlaceholder: "Пошук за ім'ям або містом...",
      myContacts: "Мої контакти",
      findPeople: "Знайти людей",
      addContact: "Додати",
      added: "Додано",
      removeContact: "Видалити",
      noContacts: "Контактів ще немає",
      noContactsSub: "Шукайте людей або запрошуйте друзів приєднатись",
      noResults: "Людей не знайдено",
      message: "Написати",
      viewProfile: "Профіль",
      connected: "З'єднано",
      booksShared: "книг",
